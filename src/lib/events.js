...
// ----------------------------------------------------------------------------
//
// We scan every string (and number, coerced to string) value in an event's
// properties for patterns that look like raw PII. If any is found, the whole
// request is rejected. The intent is not perfect PII classification - it's a
// gatekeeper that forces verticals to route identifying data through the
// identity hashing API instead of smuggling it inside properties.
//
...
// vertical gets a clear, actionable error and can restructure the property.
...
// Recursively scan an arbitrary properties value for PII. Returns an array of
